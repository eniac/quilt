...
function invoke_fission_merged {
  ...
  -d '{"username":"username_888","user_id":888,"text":"Hey, this is @username_888! Nice to meet you and welcome to my personal web: https://eecs.umich.edu/~tomw @username_999 ","media_ids":[],"media_types":[],"post_type":"POST"}'
}
